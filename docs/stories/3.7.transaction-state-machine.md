...
- [ ] `app/Http/Controllers/TransactionHoldController.php`
- [ ] `app/Http/Controllers/TransactionCancelController.php`
- [ ] `app/Http/Requests/HoldTransactionRequest.php`
- [ ] `app/Http/Requests/CancelTransactionRequest.php`
- [ ] `resources/js/Components/HoldTransactionModal.tsx`
- [ ] `resources/js/Components/CancelTransactionModal.tsx`
- [ ] `resources/js/Components/ResumeTransactionModal.tsx`
- [ ] `resources/js/Components/StatusBadge.tsx`
- [ ] `tests/Unit/Services/TransactionStateMachineTest.php`
- [ ] `tests/Feature/TransactionStateTest.php`
