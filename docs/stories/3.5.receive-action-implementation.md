...
- [ ] Pending receipts page shows transactions awaiting receipt
- [ ] Pending count badge appears in navigation
- [ ] Receive button visible on transaction detail when conditions met
- [ ] Receive confirmation modal shows transaction summary
- [ ] Single receive creates transaction_action record correctly
- [ ] Transaction updated with current_user and received_at
- [ ] Workflow step advances after receive (when in-workflow)
- [ ] Bulk receive processes multiple transactions
- [ ] Bulk receive reports success/failure summary
- [ ] Success toast displayed after receive
- [ ] Transaction removed from pending list after receive
- [ ] Action history shows receive action
...
### Files Created
- [ ] `app/Http/Controllers/TransactionReceiveController.php`
- [ ] `app/Http/Requests/ReceiveTransactionRequest.php`
- [ ] `app/Http/Requests/ReceiveBulkRequest.php`
- [ ] `resources/js/Pages/Transactions/Pending.tsx`
- [ ] `tests/Feature/TransactionReceiveTest.php`
...
- [ ] `resources/js/Layouts/AuthenticatedLayout.tsx` (navigation badge)
