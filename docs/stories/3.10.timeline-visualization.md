...
### Files Created
- [x] `app/Services/TimelineService.php`
- [x] `resources/js/Components/Timeline/TransactionTimeline.tsx`
- [x] `resources/js/Components/Timeline/TimelineStep.tsx`
- [x] `resources/js/Components/Timeline/ProgressBar.tsx`
- [x] `resources/js/Components/ActionHistory.tsx`
- [x] `resources/js/Components/CompactProgress.tsx`
- [x] `tests/Feature/TransactionTimelineTest.php`

### Files Modified
- [x] `app/Http/Controllers/PurchaseRequestController.php` - Added TimelineService injection, timeline + actionHistory props
- [x] `app/Http/Controllers/PurchaseOrderController.php` - Added TimelineService injection, timeline + actionHistory props
- [x] `app/Http/Controllers/VoucherController.php` - Added TimelineService injection, timeline + actionHistory props
- [x] `resources/js/Pages/PurchaseRequests/Show.tsx` - Added TransactionTimeline and ActionHistory components
- [x] `resources/js/Pages/PurchaseOrders/Show.tsx` - Added TransactionTimeline and ActionHistory components
- [x] `resources/js/Pages/Vouchers/Show.tsx` - Added TransactionTimeline and ActionHistory components
- [x] `resources/js/types/models.ts` - Added TimelineStep, TransactionTimeline, ActionHistoryEntry interfaces

### Test Results
- [x] Feature tests: 12 passing (86 assertions)
- [x] TypeScript: Compiles cleanly (no errors)
- [x] Existing tests: No regressions (EndorsementService 45 passing, OutOfWorkflow 15 passing)

### Implementation Notes
- Updated 3 controllers (PR/PO/VCH) instead of nonexistent TransactionController.php
- Updated 3 show pages instead of nonexistent Transactions/Show.tsx
- Timeline uses EtaCalculationService for running ETA computation on upcoming steps
- Horizontal layout for desktop (md+), vertical layout for mobile
- Progress bar color-coded by delay severity (green/yellow/red)
- ActionHistory component modeled after existing TransactionActivityTimeline but scoped to single transaction
- CompactProgress component (step dots) available for list views
- Completed transactions show all steps as completed with 100% progress
- Out-of-workflow warning displayed in timeline when detected
