...
import { ActionTaken } from '@/types/models';
...
export default function Edit({ auth, actionTaken }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        description: actionTaken.description,
        is_active: actionTaken.is_active,
    });

    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('admin.repositories.action-taken.update', actionTaken.id));
    };
