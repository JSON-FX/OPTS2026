...
export default function Show({ purchaseRequest, canEdit, canDelete, canEndorse, cannotEndorseReason, canReceive, cannotReceiveReason, canComplete, cannotCompleteReason, actionTakenOptions, defaultActionTakenId, canHold, cannotHoldReason, canCancel, cannotCancelReason, canResume, cannotResumeReason, outOfWorkflowInfo, timeline, actionHistory }: Props) {
