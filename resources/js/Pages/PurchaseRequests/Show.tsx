...
export default function Show({ purchaseRequest, canEdit, canDelete, canEndorse, cannotEndorseReason, canReceive, cannotReceiveReason, canComplete, cannotCompleteReason, actionTakenOptions, canHold, cannotHoldReason, canCancel, cannotCancelReason, canResume, cannotResumeReason, outOfWorkflowInfo, timeline, actionHistory }: Props) {
